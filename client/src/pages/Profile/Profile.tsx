/*//Этот файл представляет компонент React для отображения профиля пользователя (UserProfile). 
//Он включает в себя таблицу с заказами пользователя, а также функциональность для удаления заказов, 
//редактирования заказов и генерации договоров для выбранных заказов. 
//Компонент также содержит информацию о пользователе, такую как ID, имя, электронная почта и статус администратора.*/
